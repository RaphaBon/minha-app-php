                ...
                <div class="col-6">
                    <div class="mb-2">
                        ...
                        <input class="form-control" type="email" name="email" id="email" placeholder="Digite seu email"
                            required value="<?=$registroContato["email"]?>">
                    </div>
                </div>
                <div class="col-12">
                    <div class="mb-2">
                        <label for="email">Mensagem</label>
                        <textarea class="form-control" name="msg" id="msg" cols="30" rows="3"
                            required><?=$registroContato["mensagem"]?></textarea>
                    </div>
                </div>
                <div class="col-12">
                    <div class="mb-2">
                        <label for="email">Data/Hora</label>
                        <input class="form-control" type="text" name="datahora" id="datahora" disabled
                            value="<?=$registroContato["datahora"]?>">
                    </div>
                </div>
